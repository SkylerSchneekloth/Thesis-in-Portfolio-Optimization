...
dfMVOb <- read.csv("transCost_MVO__TotRet_max2pt5.csv",header=TRUE, row.names=1)
dfMVOc <- read.csv("transCost_MVO__TotRet_max7pt5.csv",header=TRUE, row.names=1)
...
results_df <- data.frame(
  ...
  Average_Sharpe = c(average_sharpe_SP500, average_sharpe_RAND, average_sharpe_MVOa, average_sharpe_MVOb, average_sharpe_MVOc, average_sharpe_Shrink0, average_sharpe_Shrink1, average_sharpe_Shrink2, average_sharpe_Shrink3, average_sharpe_Shrink4, average_sharpe_ShrinkLW, average_sharpe_REa, average_sharpe_REb),
  Average_TR = c(average_TR_SP500, average_TR_RAND, average_TR_MVOa, average_TR_MVOb, average_TR_MVOc, average_TR_Shrink0, average_TR_Shrink1, average_TR_Shrink2, average_TR_Shrink3, average_TR_Shrink4, average_TR_ShrinkLW, average_TR_REa, average_TR_REb)
)
